...
QPLPInternal::QPLPInternal(const std::vector<CCSSparsity> &st) : LPSolverInternal(st) {
...
void QPLPInternal::init(){
  ...
  qpsolver_ = qpsolver_creator(qpStruct("h",sp_sparseQQQ(n_,n_),"a",input(LP_SOLVER_A).sparsity()));
