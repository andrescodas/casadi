...
namespace CasADi{
  ...
  */
  ...
  public:
     ...
     */
    SimpleIndefDpleInternal(const std::vector< CCSSparsity > & A, const std::vector< CCSSparsity > &V);
    ...
    virtual SimpleIndefDpleInternal* create(const std::vector< CCSSparsity > & A, const std::vector< CCSSparsity > &V) const{ return new SimpleIndefDpleInternal(A,V);}
