...
namespace CasADi{
  ...
  */
  ...
  public:
     ...
     */
    DpleInternal(const std::vector< CCSSparsity > & A, const std::vector< CCSSparsity > &V, int nfwd=0, int nadj=0);
    ...
    virtual DpleInternal* create(const std::vector< CCSSparsity > & A, const std::vector< CCSSparsity > &V) const = 0;
    ...
    std::vector< CCSSparsity > A_;
    
    /// List of sparsities of V_i 
    std::vector< CCSSparsity > V_;
