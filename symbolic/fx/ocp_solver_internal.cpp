...
void OCPSolverInternal::init(){
  ...
  input(OCP_LBX) = input(OCP_UBX) = input(OCP_X_INIT) = Matrix<double>(00,00,00,nk_+1,nx_,0);
  input(OCP_LBU) = input(OCP_UBU) = input(OCP_U_INIT) = Matrix<double>(00,00,00,nk_,nu_,0);
  input(OCP_LBP) = input(OCP_UBP) = input(OCP_P_INIT) = Matrix<double>(00,00,00,1,np_,0);
  input(OCP_LBH) = input(OCP_UBH) = Matrix<double>(00,00,00,nk_+1,nh_,0);
  input(OCP_LBG) = input(OCP_UBG) = Matrix<double>(00,00,00,1,ng_,0);
