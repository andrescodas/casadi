...
class CustomFunctionInternal : public FXInternal{
  ...
  public:
    ...
    explicit CustomFunctionInternal(const CustomEvaluate &c_fcn, const std::vector<CasADi::CCSSparsity> &inputscheme, const std::vector<CasADi::CCSSparsity> &outputscheme);
