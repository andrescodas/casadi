...
CustomFunctionInternal::CustomFunctionInternal(const CustomEvaluate &c_fcn, const std::vector<CasADi::CCSSparsity> &inputscheme, const std::vector<CasADi::CCSSparsity> &outputscheme) : evaluate_(c_fcn){
