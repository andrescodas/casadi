  ...
  */
  ...
  public:
    ...
    */
    ...
    void getPartition(int iind, int oind, CCSSparsity& D1, CCSSparsity& D2, bool compact, bool symmetric);
    ...
    Matrix<CCSSparsity> jac_sparsityQQQ_, jac_sparsityQQQ_compact_;
