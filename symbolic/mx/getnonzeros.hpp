...
namespace CasADi{
  ...
  */
  ...
  public:
    ...
    /// Constructor
    GetNonzeros(const CCSSparsity& sp, const MX& x);
  ...
  public:
    /// Constructor
    GetNonzerosVector(const CCSSparsity& sp, const MX& x, const std::vector<int>& nz) : GetNonzeros(sp,x), nz_(nz){}
  ...
  public:
    ...
    /// Constructor
    GetNonzerosSlice(const CCSSparsity& sp, const MX& x, const Slice& s) : GetNonzeros(sp,x), s_(s){}
  ...
  public:
    ...
    /// Constructor
    GetNonzerosSlice2(const CCSSparsity& sp, const MX& x, const Slice& inner, const Slice& outer) : GetNonzeros(sp,x), inner_(inner), outer_(outer){}
