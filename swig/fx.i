...
%template(__call__) operator()< CasADi::CCSSparsity >;
...
%template(IOSchemeVectorCCSSparsity) CasADi::IOSchemeVector< CasADi::CCSSparsity >;
#ifdef SWIGPYTHON
...
%extend CasADi::IOSchemeVector< CasADi::CCSSparsity > {
%pythoncode %{
  def __iter__(self):
    return self.data.__iter__()
%}
