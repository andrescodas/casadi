...
public:
  ...
  */
  ...
  bool eval_jac_g(int n, const double* x, bool new_x,int m, int nele_jac, int* iCol, int *jRow,double* values);
  bool eval_h(const double* x, bool new_x, double obj_factor, const double* lambda,bool new_lambda, int nele_hess, int* iCol,int* jRow, double* values);
