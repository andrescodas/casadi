...
namespace CasADi{
  ...
  */
  ...
  public:
    ...
    explicit LapackQRDense(const CCSSparsity& sparsity, int nrhs=1);
    ...
    %callback("%s_cb");
#endif
    static LinearSolver creator(const CCSSparsity& sp, int nrhs){ return LapackQRDense(sp, nrhs);}
#ifdef SWIG
    %nocallback;
#endif
  ...
  public:
    ...
    LapackQRDenseInternal(const CCSSparsity& sparsity, int nrhs);
